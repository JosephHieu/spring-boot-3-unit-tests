...
public class GradebookControllerTest {
    ...
    public static void setup() {
        ...
        request.setParameter("firstname", "Nguyen");
        request.setParameter("lastname", "Hieu");
        request.setParameter("emailAddress", "hieu@gmail.com");
    }
    ...
    @Test
    public void deleteStudentRequest() throws Exception {
