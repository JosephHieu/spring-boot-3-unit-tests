package com.josephHieu.component;
...
public class ApplicationExampleTest {
    ...
    public void beforeEach() {
        ...
        student.setEmailAddress("eric.com.vn");
        studentGrades.setMathGradeResults(new ArrayList<>(Arrays.asList(100.00, 85.0, 76.50, 91.75)));
    ...
    public void createStudentWithoutGradesInit() {
        ...
        studentTwo.setFirstname("Nguyen");
        studentTwo.setLastname("Hieu");
        studentTwo.setEmailAddress("hieu@gmail.com");
